...
{
    public static function createInternalErrorsMiddleware(callable $delayFunction = null, int $maxRetries = 5): callable
    {
        return static::createMiddlewareByHttpCodeRange(500, 504, $delayFunction, $maxRetries);
    }

    public static function createRateLimitMiddleware(callable $delayFunction = null, int $maxRetries = 5)
    {
